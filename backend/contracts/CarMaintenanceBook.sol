...
contract CarMaintenanceBook is ERC721, Ownable, IERC5192 {
    ...
    /// @notice Mapping to store distributor status.
    /// @dev The distributors mapping tracks whether a specific address is registered as a distributor or not.
    /// Distributors have special privileges, such as the ability to mint and transfer NFTs.
    mapping(address => bool) public distributors;

    /// @notice ERC20 Token used for the cagnotte (prize pool).
    /// @dev The cagnotteToken variable represents the ERC20 token used for the cagnotte associated with the NFTs.
    /// This token is used to reward users for claiming and performing maintenance on their NFTs.
    ...
    /// @notice Emitted when a distributor is registered.
    ...
    /// @param _cagnotteToken The address of the associated CarMaintenanceLoyalty token.
    ...
    /// @notice Registers a distributor with the specified address.
    /// @dev Only the owner can register distributors.
    /// @param _distributor The address of the distributor to be registered.
    ...
    /// @dev Only the owner can set the cagnotte token address.
    /// @param _cagnotteToken The address of the CarMaintenanceLoyalty token.
